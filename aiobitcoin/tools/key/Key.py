...
class Key(object):
    ...
    @classmethod
    def from_text(cls, text, is_compressed=False):
        """
        ...
        if key_type in ("pub32", "prv32"):
            # : fix this... it doesn't belong here
            from aiobitcoin.tools.key.BIP32Node import BIP32Node
    ...
    def sign(self, h):
        ...
        val = from_bytes_32(h)
        r, s = ecdsa.sign(ecdsa.generator_secp256k1, self.secret_exponent(), val)
